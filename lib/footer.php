...
<div class="mt-28">
    ...
    <div data-aos="fade-up" class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
        <div class="relative md:w-5/12">
            <img class="rounded-2xl" src="assets/img/lom.jpg" alt="">
        ...
        <div class="relative md:w-5/12">
            <img class="rounded-2xl" src="assets/img/Rectangle%2021.png" alt="">
            <div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
...
<div class="sm:flex items-center sm:space-x-8 mt-36">
    <div data-aos="fade-right" class="sm:w-1/2 relative">
        ...
        <h1 class="font-semibold text-2xl relative z-50 text-darken lg:pr-10">Everything from children's education to post-doctoral level is available <span class="text-yellow-500">on this site</span></h1>
        <p class="py-5 lg:pr-32">Don't worry at all, your child is of utmost importance to us. Our priority is children </p>
...
<div class="md:flex mt-40 md:space-x-10 items-start">
    ...
    <div data-aos="fade-down" class="md:w-5/12 mt-20 md:mt-0 text-gray-500">
        <h1 class="text-2xl font-semibold text-darken lg:pr-40">Connect to all university professors <span class="text-yellow-500">for free</span>.</h1>
    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="text-center text-white">
            ...
            <div class="py-3 tracking-wide">
                <p>Code By <span class="font-semibold">HR Davar</span></p>
